...
describe("Testing Update Transaction Endpoint", () => {
  describe("Testing HTTP Method Responses", () => {
    ...
    it("Should return 200 with specific Attributes for the PUT invalidate transaction Request", done => {
    ...
    it("Should return 200  with specific Attributes for the  PATCH", done => {
      let createTransactionPayload = {
        app_id: "a46fa81d-9941-42c1-8b47-c8d57be4acc24"
      };
      chai
