...
const CONSENT_REVOKE_APP_URL = ENV.ENV_CONSENT_APP_REVOKE_URL;

module.exports = { NODE_SETTINGS,  DB_SETTINGS, CONSENT_BASE_PATH, CONSENT_REVOKE_APP_URL, AUTH_KEYS, CONSENT_KEYS, AUTHENTICATION_ACTIVE, S3_BUCKET_SETTINGS};
