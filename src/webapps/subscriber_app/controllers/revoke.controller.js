...
const { NODE_SETTINGS, APIGEE_CREDS: { apigeeBaseURL }, APIGEE_CREDS: { revokeApp }, APIGEE_CREDS: { clientSecret }, APIGEE_ENDPOINTS: { verifyOTP } } = require("../config/environment")
...
module.exports = function (req, res, next) {
    ...
    var options = {
        method: 'DELETE',
        url: `${apigeeBaseURL}/${revokeApp}/${app_id}`,
        headers:
        {
